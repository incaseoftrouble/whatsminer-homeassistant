...
from homeassistant.const import FREQUENCY_MEGAHERTZ, TEMP_CELSIUS, FREQUENCY_HERTZ, POWER_WATT, TIME_SECONDS
...
class WhatsminerSensorEntityDescription(SensorEntityDescription):
    value: Callable[[OnlineMinerData], StateType | date | datetime | Decimal] | None = None
...
class WhatsminerSensor(OnlineWhatsminerEntity, SensorEntity):
    def __init__(self, coordinator: WhatsminerCoordinator, entity_description: WhatsminerSensorEntityDescription):
