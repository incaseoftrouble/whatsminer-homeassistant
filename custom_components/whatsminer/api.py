...
class WhatsminerAPI:
    ...
    @classmethod
    def get_read_only_info(cls, access_token: WhatsminerAccessToken, cmd: str, additional_params: dict = None):
    ...
    @classmethod
    def exec_command(cls, access_token: WhatsminerAccessToken, cmd: str, additional_params: dict = None):
        ...
        enc_str = str(base64.encodebytes(access_token.cipher.encrypt(add_to_16(api_cmd))),
                      encoding='utf8').replace('\n', '')
        data_enc = {'enc': 1, 'data': enc_str}  # transmit w/ "enc" to signal that it's encrypted
